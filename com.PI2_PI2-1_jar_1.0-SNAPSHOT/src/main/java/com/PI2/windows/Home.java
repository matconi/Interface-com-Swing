...
package com.PI2.windows;

import PI2.Env;
import com.PI2.database.ContactDao;
import com.PI2.database.DatabaseConnection;
import com.PI2.database.MessageDao;
import com.PI2.database.UserDao;
import com.PI2.entities.User;
import comPI2.windows.contacts.AddContForm;
import com.PI2.windows.users.LoginForm;
import com.PI2.entities.Contact;
import com.PI2.entities.Message;
import com.PI2.validators.TreatmentException;
import com.PI2.validators.Validators;
import com.PI2.windows.messages.AddMesForm;
import com.PI2.windows.messages.SendboxForm;
...
public class Home extends javax.swing.JFrame {
    ...
    private void loadInboxTable() throws SQLException {
        ...
        for (Message message : messages) {  
            ...
            inboxModel.addRow(new Object[]{
               contactName, message.getMessage(), message.getId(), message.getContId()
            });
        }  
        databaseConnection.getConnection().close();  
    }      
    ...
    private void initComponents() {
        ...
        deselectUBtn = new javax.swing.JButton();
        ...
        deselectCBtn = new javax.swing.JButton();
        ...
        deselectIBtn = new javax.swing.JButton();
        ...
        deselectUBtn.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        deselectUBtn.setText("Deselect");
        deselectUBtn.setToolTipText("Retira a seleção da tabela");
        deselectUBtn.setBorder(null);
        deselectUBtn.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                deselectUBtnActionPerformed(evt);
            }
        });
        ...
        userPanelLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, userPanelLayout.createSequentialGroup()
                ...
                .addGroup(userPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addComponent(scrollUserTable, javax.swing.GroupLayout.DEFAULT_SIZE, 620, Short.MAX_VALUE))
                .addGap(18, 18, 18)
                .addGroup(userPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(deselectUBtn, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addGap(25, 25, 25))
        );
            ...
            .addGroup(userPanelLayout.createSequentialGroup()
                ...
                .addGroup(userPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(userPanelLayout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(deselectUBtn, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        deselectCBtn.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        deselectCBtn.setText("Deselect");
        deselectCBtn.setToolTipText("Retira a seleção da tabela");
        deselectCBtn.setBorder(null);
        deselectCBtn.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                deselectCBtnActionPerformed(evt);
            }
        });
        ...
        reloadCBtn.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        reloadCBtn.setText("Recarregar");
        reloadCBtn.setToolTipText("Retira a seleção da tabela");
        reloadCBtn.setBorder(null);
                ...
                .addGroup(contPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(contPanelLayout.createSequentialGroup()
                        ...
                        .addGroup(contPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(contPanelLayout.createSequentialGroup()
                                .addComponent(deselectCBtn, javax.swing.GroupLayout.PREFERRED_SIZE, 94, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
                                .addComponent(excContBtn, javax.swing.GroupLayout.PREFERRED_SIZE, 60, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addComponent(editContBtn, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(reloadCBtn, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                        .addGap(30, 30, 30))))
        );
            ...
            .addGroup(contPanelLayout.createSequentialGroup()
                ...
                .addGroup(contPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(contPanelLayout.createSequentialGroup()
                        ...
                        .addGap(26, 26, 26)
                        .addComponent(reloadCBtn, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(28, 28, 28)
                        .addGroup(contPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            ...
                            .addComponent(deselectCBtn, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addComponent(scrollContTable, javax.swing.GroupLayout.PREFERRED_SIZE, 227, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 31, Short.MAX_VALUE)
        ...
        inboxTable.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        inboxTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Contato", "Mensagem", "msgid", "contid"
            }
        ) {
            Class[] types = new Class [] {
        ...
        if (inboxTable.getColumnModel().getColumnCount() > 0) {
            ...
            inboxTable.getColumnModel().getColumn(3).setMinWidth(0);
            inboxTable.getColumnModel().getColumn(3).setPreferredWidth(0);
            inboxTable.getColumnModel().getColumn(3).setMaxWidth(0);
        }

        readBtn.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        ...
        responseBtn.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        ...
        deleteInboxBtn.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        ...
        sendedBtn.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        ...
        inboxLb.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        inboxLb.setForeground(new java.awt.Color(255, 255, 255));
        inboxLb.setLabelFor(inboxTable);
        inboxLb.setText("Caixa de Entrada");

        deselectIBtn.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        deselectIBtn.setText("Deselect");
        deselectIBtn.setToolTipText("Retira a seleção da tabela");
        deselectIBtn.setBorder(null);
        deselectIBtn.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                deselectIBtnActionPerformed(evt);
            }
        });

        reloadIBtn.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        reloadIBtn.setText("Recarregar");
        reloadIBtn.setToolTipText("Retira a seleção da tabela");
        reloadIBtn.setBorder(null);
                ...
                .addGroup(messagePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(messagePanelLayout.createSequentialGroup()
                        .addGroup(messagePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(scrollInboxTable))
                        .addGap(18, 18, 18))
                    .addGroup(messagePanelLayout.createSequentialGroup()
                        .addComponent(inboxLb)
                        .addGap(415, 415, 415)))
                .addGroup(messagePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(readBtn, javax.swing.GroupLayout.DEFAULT_SIZE, 198, Short.MAX_VALUE)
                    ...
                    .addGroup(messagePanelLayout.createSequentialGroup()
                        .addComponent(deselectIBtn, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(sendedBtn, javax.swing.GroupLayout.PREFERRED_SIZE, 112, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addComponent(reloadIBtn, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 107, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(30, 30, 30))
        );
        messagePanelLayout.setVerticalGroup(
            ...
            .addGroup(messagePanelLayout.createSequentialGroup()
                ...
                .addGroup(messagePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(inboxLb)
                    .addComponent(reloadIBtn, javax.swing.GroupLayout.DEFAULT_SIZE, 29, Short.MAX_VALUE))
                .addGap(15, 15, 15)
                .addGroup(messagePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(messagePanelLayout.createSequentialGroup()
                        ...
                        .addGap(28, 28, 28)
                        .addComponent(responseBtn, javax.swing.GroupLayout.PREFERRED_SIZE, 55, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(deleteInboxBtn)))
                .addGroup(messagePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(messagePanelLayout.createSequentialGroup()
                        .addGap(18, 18, 18)
                    ...
                    .addGroup(messagePanelLayout.createSequentialGroup()
                        .addGap(46, 46, 46)
                        .addGroup(messagePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(sendedBtn, javax.swing.GroupLayout.DEFAULT_SIZE, 40, Short.MAX_VALUE)
                            .addComponent(deselectIBtn, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))))
    ...
    private void responseBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_responseBtnActionPerformed
        ...
        if (rowSelected != -1) {
            if (!inboxTable.getValueAt(rowSelected, 0).equals("[Desconhecido]")) {
                ...
                addMesForm.setTitle("Responder mensagem");
    ...
    private void deselectUBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deselectUBtnActionPerformed
        deselect(userTable);
    }//GEN-LAST:event_deselectUBtnActionPerformed
    ...
    private void deselectCBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deselectCBtnActionPerformed
        deselect(contTable);
    }//GEN-LAST:event_deselectCBtnActionPerformed

    private void deselectIBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deselectIBtnActionPerformed
        deselect(inboxTable);
    }//GEN-LAST:event_deselectIBtnActionPerformed
    ...
    private javax.swing.JButton deselectCBtn;
    private javax.swing.JButton deselectIBtn;
    private javax.swing.JButton deselectUBtn;
    ...
    public static JTable getInboxTable() {
        return Home.inboxTable;
    }
    
    public static int getInboxTableContId() {
        return (int) Home.inboxTable.getValueAt(inboxTable.getSelectedRow(), 3);
    }
